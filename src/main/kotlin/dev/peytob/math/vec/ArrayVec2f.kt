...
internal class ArrayVec2f internal constructor(
   ...
   */
  override operator fun plus(right: Vec2f): ArrayVec2f {
   ...
   * Component-wise plus operation with vectors. Result will be written into left vector
   */
  override operator fun plus(right: Vec2d): ArrayVec2f {
    this.x = (this.x + right.x).toFloat()
    this.y = (this.y + right.y).toFloat()
    return this
  }
   ...
   * Component-wise plus operation with vectors. Result will be written into left vector
   */
  override operator fun plus(right: Vec2i): ArrayVec2f {
    this.x = (this.x + right.x).toFloat()
    this.y = (this.y + right.y).toFloat()
    return this
  }
   ...
   * Component-wise plus operation with vectors. Result will be written into left vector
   */
  override operator fun plus(right: Vec2l): ArrayVec2f {
    this.x = (this.x + right.x).toFloat()
    this.y = (this.y + right.y).toFloat()
    return this
  }
   ...
   */
  override fun plus(x: Float, y: Float): ArrayVec2f {
   ...
   * Component-wise plus operation with vectors. Right vector presented as set of scalars. Result will be written into left vector
   */
  override fun plus(x: Double, y: Double): ArrayVec2f {
    this.x = (this.x + x).toFloat()
    this.y = (this.y + y).toFloat()
    return this
  }
   ...
   * Component-wise plus operation with vectors. Right vector presented as set of scalars. Result will be written into left vector
   */
  override fun plus(x: Int, y: Int): ArrayVec2f {
    this.x = (this.x + x).toFloat()
    this.y = (this.y + y).toFloat()
    return this
  }
   ...
   * Component-wise plus operation with vectors. Right vector presented as set of scalars. Result will be written into left vector
   */
  override fun plus(x: Long, y: Long): ArrayVec2f {
    this.x = (this.x + x).toFloat()
    this.y = (this.y + y).toFloat()
    return this
  }
   ...
   */
  override operator fun plus(right: Float): ArrayVec2f {
   ...
   * Component-wise plus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun plus(right: Double): ArrayVec2f {
    this.x = (this.x + right).toFloat()
    this.y = (this.y + right).toFloat()
    return this
  }
   ...
   * Component-wise plus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun plus(right: Int): ArrayVec2f {
    this.x = (this.x + right).toFloat()
    this.y = (this.y + right).toFloat()
    return this
  }
   ...
   * Component-wise plus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun plus(right: Long): ArrayVec2f {
    this.x = (this.x + right).toFloat()
    this.y = (this.y + right).toFloat()
    return this
  }
   ...
   */
  override operator fun minus(right: Vec2f): ArrayVec2f {
    this.x = (this.x - right.x).toFloat()
    this.y = (this.y - right.y).toFloat()
    return this
  }
   ...
   * Component-wise minus operation with vectors. Result will be written into left vector
   */
  override operator fun minus(right: Vec2d): ArrayVec2f {
    this.x = (this.x - right.x).toFloat()
    this.y = (this.y - right.y).toFloat()
    return this
  }
   ...
   * Component-wise minus operation with vectors. Result will be written into left vector
   */
  override operator fun minus(right: Vec2i): ArrayVec2f {
    this.x = (this.x - right.x).toFloat()
    this.y = (this.y - right.y).toFloat()
    return this
  }
   ...
   * Component-wise minus operation with vectors. Result will be written into left vector
   */
  override operator fun minus(right: Vec2l): ArrayVec2f {
    this.x = (this.x - right.x).toFloat()
    this.y = (this.y - right.y).toFloat()
    return this
  }
   ...
   */
  override fun minus(x: Float, y: Float): ArrayVec2f {
    this.x = (this.x - x).toFloat()
    this.y = (this.y - y).toFloat()
    return this
  }
   ...
   * Component-wise minus operation with vectors. Right vector presented as set of scalars. Result will be written into left vector
   */
  override fun minus(x: Double, y: Double): ArrayVec2f {
    this.x = (this.x - x).toFloat()
    this.y = (this.y - y).toFloat()
    return this
  }
   ...
   * Component-wise minus operation with vectors. Right vector presented as set of scalars. Result will be written into left vector
   */
  override fun minus(x: Int, y: Int): ArrayVec2f {
    this.x = (this.x - x).toFloat()
    this.y = (this.y - y).toFloat()
    return this
  }
   ...
   * Component-wise minus operation with vectors. Right vector presented as set of scalars. Result will be written into left vector
   */
  override fun minus(x: Long, y: Long): ArrayVec2f {
    this.x = (this.x - x).toFloat()
    this.y = (this.y - y).toFloat()
    return this
  }
   ...
   */
  override operator fun minus(right: Float): ArrayVec2f {
    this.x = (this.x - right).toFloat()
    this.y = (this.y - right).toFloat()
    return this
  }
   ...
   * Component-wise minus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun minus(right: Double): ArrayVec2f {
    this.x = (this.x - right).toFloat()
    this.y = (this.y - right).toFloat()
    return this
  }
   ...
   * Component-wise minus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun minus(right: Int): ArrayVec2f {
    this.x = (this.x - right).toFloat()
    this.y = (this.y - right).toFloat()
    return this
  }
   ...
   * Component-wise minus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun minus(right: Long): ArrayVec2f {
    this.x = (this.x - right).toFloat()
    this.y = (this.y - right).toFloat()
    return this
  }
   ...
   */
  override operator fun times(right: Vec2f): ArrayVec2f {
    this.x = (this.x * right.x).toFloat()
    this.y = (this.y * right.y).toFloat()
    return this
  }
   ...
   * Component-wise multiplication operation with vectors. Result will be written into left vector
   */
  override operator fun times(right: Vec2d): ArrayVec2f {
    this.x = (this.x * right.x).toFloat()
    this.y = (this.y * right.y).toFloat()
    return this
  }
   ...
   * Component-wise multiplication operation with vectors. Result will be written into left vector
   */
  override operator fun times(right: Vec2i): ArrayVec2f {
    this.x = (this.x * right.x).toFloat()
    this.y = (this.y * right.y).toFloat()
    return this
  }
   ...
   * Component-wise multiplication operation with vectors. Result will be written into left vector
   */
  override operator fun times(right: Vec2l): ArrayVec2f {
    this.x = (this.x * right.x).toFloat()
    this.y = (this.y * right.y).toFloat()
    return this
  }
   ...
   */
  override fun times(x: Float, y: Float): ArrayVec2f {
    this.x = (this.x * x).toFloat()
    this.y = (this.y * y).toFloat()
    return this
  }
   ...
   * Component-wise multiplication operation with vectors. Right vector presented as set of scalars. Result will be written into left vector
   */
  override fun times(x: Double, y: Double): ArrayVec2f {
    this.x = (this.x * x).toFloat()
    this.y = (this.y * y).toFloat()
    return this
  }
   ...
   * Component-wise multiplication operation with vectors. Right vector presented as set of scalars. Result will be written into left vector
   */
  override fun times(x: Int, y: Int): ArrayVec2f {
    this.x = (this.x * x).toFloat()
    this.y = (this.y * y).toFloat()
    return this
  }
   ...
   * Component-wise multiplication operation with vectors. Right vector presented as set of scalars. Result will be written into left vector
   */
  override fun times(x: Long, y: Long): ArrayVec2f {
    this.x = (this.x * x).toFloat()
    this.y = (this.y * y).toFloat()
    return this
  }
   ...
   */
  override operator fun times(right: Float): ArrayVec2f {
    this.x = (this.x * right).toFloat()
    this.y = (this.y * right).toFloat()
    return this
  }
   ...
   * Component-wise multiplication operation between vector and scalar. Result will be written into left vector
   */
  override operator fun times(right: Double): ArrayVec2f {
    this.x = (this.x * right).toFloat()
    this.y = (this.y * right).toFloat()
    return this
  }
   ...
   * Component-wise multiplication operation between vector and scalar. Result will be written into left vector
   */
  override operator fun times(right: Int): ArrayVec2f {
    this.x = (this.x * right).toFloat()
    this.y = (this.y * right).toFloat()
    return this
  }
   ...
   * Component-wise multiplication operation between vector and scalar. Result will be written into left vector
   */
  override operator fun times(right: Long): ArrayVec2f {
    this.x = (this.x * right).toFloat()
    this.y = (this.y * right).toFloat()
    return this
  }
