...
internal class ArrayVec3d internal constructor(
   ...
   */
  override operator fun plus(right: Vec3f): ArrayVec3d {
   ...
   * Component-wise plus operation with vectors. Result will be written into left vector
   */
  override operator fun plus(right: Vec3d): ArrayVec3d {
    this.x = (this.x + right.x).toDouble()
    this.y = (this.y + right.y).toDouble()
    this.z = (this.z + right.z).toDouble()
    return this
   ...
   * Component-wise plus operation with vectors. Result will be written into left vector
   */
  override operator fun plus(right: Vec3i): ArrayVec3d {
    this.x = (this.x + right.x).toDouble()
    this.y = (this.y + right.y).toDouble()
    this.z = (this.z + right.z).toDouble()
    return this
   ...
   * Component-wise plus operation with vectors. Result will be written into left vector
   */
  override operator fun plus(right: Vec3l): ArrayVec3d {
    this.x = (this.x + right.x).toDouble()
    this.y = (this.y + right.y).toDouble()
    this.z = (this.z + right.z).toDouble()
    return this
   ...
   */
  override operator fun plus(right: Float): ArrayVec3d {
    this.x = (this.x + right).toDouble()
    this.y = (this.y + right).toDouble()
    this.z = (this.z + right).toDouble()
    return this
  }
   ...
   * Component-wise plus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun plus(right: Double): ArrayVec3d {
    this.x = (this.x + right).toDouble()
    this.y = (this.y + right).toDouble()
    this.z = (this.z + right).toDouble()
    return this
   ...
   * Component-wise plus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun plus(right: Int): ArrayVec3d {
    this.x = (this.x + right).toDouble()
    this.y = (this.y + right).toDouble()
    this.z = (this.z + right).toDouble()
    return this
   ...
   * Component-wise plus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun plus(right: Long): ArrayVec3d {
    this.x = (this.x + right).toDouble()
    this.y = (this.y + right).toDouble()
    this.z = (this.z + right).toDouble()
    return this
   ...
   */
  override operator fun minus(right: Vec3f): ArrayVec3d {
    this.x = (this.x - right.x).toDouble()
    this.y = (this.y - right.y).toDouble()
    this.z = (this.z - right.z).toDouble()
    return this
   ...
   * Component-wise minus operation with vectors. Result will be written into left vector
   */
  override operator fun minus(right: Vec3d): ArrayVec3d {
    this.x = (this.x - right.x).toDouble()
    this.y = (this.y - right.y).toDouble()
    this.z = (this.z - right.z).toDouble()
    return this
   ...
   * Component-wise minus operation with vectors. Result will be written into left vector
   */
  override operator fun minus(right: Vec3i): ArrayVec3d {
    this.x = (this.x - right.x).toDouble()
    this.y = (this.y - right.y).toDouble()
    this.z = (this.z - right.z).toDouble()
    return this
   ...
   * Component-wise minus operation with vectors. Result will be written into left vector
   */
  override operator fun minus(right: Vec3l): ArrayVec3d {
    this.x = (this.x - right.x).toDouble()
    this.y = (this.y - right.y).toDouble()
    this.z = (this.z - right.z).toDouble()
    return this
   ...
   */
  override operator fun minus(right: Float): ArrayVec3d {
    this.x = (this.x - right).toDouble()
    this.y = (this.y - right).toDouble()
    this.z = (this.z - right).toDouble()
    return this
   ...
   * Component-wise minus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun minus(right: Double): ArrayVec3d {
    this.x = (this.x - right).toDouble()
    this.y = (this.y - right).toDouble()
    this.z = (this.z - right).toDouble()
    return this
   ...
   * Component-wise minus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun minus(right: Int): ArrayVec3d {
    this.x = (this.x - right).toDouble()
    this.y = (this.y - right).toDouble()
    this.z = (this.z - right).toDouble()
    return this
   ...
   * Component-wise minus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun minus(right: Long): ArrayVec3d {
    this.x = (this.x - right).toDouble()
    this.y = (this.y - right).toDouble()
    this.z = (this.z - right).toDouble()
    return this
   ...
   */
  override operator fun times(right: Vec3f): ArrayVec3d {
    this.x = (this.x * right.x).toDouble()
    this.y = (this.y * right.y).toDouble()
    this.z = (this.z * right.z).toDouble()
    return this
   ...
   * Component-wise multiplication operation with vectors. Result will be written into left vector
   */
  override operator fun times(right: Vec3d): ArrayVec3d {
    this.x = (this.x * right.x).toDouble()
    this.y = (this.y * right.y).toDouble()
    this.z = (this.z * right.z).toDouble()
    return this
   ...
   * Component-wise multiplication operation with vectors. Result will be written into left vector
   */
  override operator fun times(right: Vec3i): ArrayVec3d {
    this.x = (this.x * right.x).toDouble()
    this.y = (this.y * right.y).toDouble()
    this.z = (this.z * right.z).toDouble()
    return this
   ...
   * Component-wise multiplication operation with vectors. Result will be written into left vector
   */
  override operator fun times(right: Vec3l): ArrayVec3d {
    this.x = (this.x * right.x).toDouble()
    this.y = (this.y * right.y).toDouble()
    this.z = (this.z * right.z).toDouble()
    return this
   ...
   */
  override operator fun times(right: Float): ArrayVec3d {
    this.x = (this.x * right).toDouble()
    this.y = (this.y * right).toDouble()
    this.z = (this.z * right).toDouble()
    return this
   ...
   * Component-wise multiplication operation between vector and scalar. Result will be written into left vector
   */
  override operator fun times(right: Double): ArrayVec3d {
    this.x = (this.x * right).toDouble()
    this.y = (this.y * right).toDouble()
    this.z = (this.z * right).toDouble()
    return this
   ...
   * Component-wise multiplication operation between vector and scalar. Result will be written into left vector
   */
  override operator fun times(right: Int): ArrayVec3d {
    this.x = (this.x * right).toDouble()
    this.y = (this.y * right).toDouble()
    this.z = (this.z * right).toDouble()
    return this
   ...
   * Component-wise multiplication operation between vector and scalar. Result will be written into left vector
   */
  override operator fun times(right: Long): ArrayVec3d {
    this.x = (this.x * right).toDouble()
    this.y = (this.y * right).toDouble()
    this.z = (this.z * right).toDouble()
    return this
