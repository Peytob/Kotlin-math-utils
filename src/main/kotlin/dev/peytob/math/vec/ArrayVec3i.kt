...
internal class ArrayVec3i internal constructor(
   ...
   */
  override operator fun plus(right: Vec3f): ArrayVec3i {
   ...
   * Component-wise plus operation with vectors. Result will be written into left vector
   */
  override operator fun plus(right: Vec3d): ArrayVec3i {
    this.x = (this.x + right.x).toInt()
    this.y = (this.y + right.y).toInt()
    this.z = (this.z + right.z).toInt()
    return this
   ...
   * Component-wise plus operation with vectors. Result will be written into left vector
   */
  override operator fun plus(right: Vec3i): ArrayVec3i {
    this.x = (this.x + right.x).toInt()
    this.y = (this.y + right.y).toInt()
    this.z = (this.z + right.z).toInt()
    return this
   ...
   * Component-wise plus operation with vectors. Result will be written into left vector
   */
  override operator fun plus(right: Vec3l): ArrayVec3i {
    this.x = (this.x + right.x).toInt()
    this.y = (this.y + right.y).toInt()
    this.z = (this.z + right.z).toInt()
    return this
   ...
   */
  override operator fun plus(right: Float): ArrayVec3i {
   ...
   * Component-wise plus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun plus(right: Double): ArrayVec3i {
    this.x = (this.x + right).toInt()
    this.y = (this.y + right).toInt()
    this.z = (this.z + right).toInt()
    return this
   ...
   * Component-wise plus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun plus(right: Int): ArrayVec3i {
    this.x = (this.x + right).toInt()
    this.y = (this.y + right).toInt()
    this.z = (this.z + right).toInt()
    return this
   ...
   * Component-wise plus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun plus(right: Long): ArrayVec3i {
    this.x = (this.x + right).toInt()
    this.y = (this.y + right).toInt()
    this.z = (this.z + right).toInt()
    return this
   ...
   */
  override operator fun minus(right: Vec3f): ArrayVec3i {
    this.x = (this.x - right.x).toInt()
    this.y = (this.y - right.y).toInt()
    this.z = (this.z - right.z).toInt()
    return this
   ...
   * Component-wise minus operation with vectors. Result will be written into left vector
   */
  override operator fun minus(right: Vec3d): ArrayVec3i {
    this.x = (this.x - right.x).toInt()
    this.y = (this.y - right.y).toInt()
    this.z = (this.z - right.z).toInt()
    return this
   ...
   * Component-wise minus operation with vectors. Result will be written into left vector
   */
  override operator fun minus(right: Vec3i): ArrayVec3i {
    this.x = (this.x - right.x).toInt()
    this.y = (this.y - right.y).toInt()
    this.z = (this.z - right.z).toInt()
    return this
   ...
   * Component-wise minus operation with vectors. Result will be written into left vector
   */
  override operator fun minus(right: Vec3l): ArrayVec3i {
    this.x = (this.x - right.x).toInt()
    this.y = (this.y - right.y).toInt()
    this.z = (this.z - right.z).toInt()
    return this
   ...
   */
  override operator fun minus(right: Float): ArrayVec3i {
    this.x = (this.x - right).toInt()
    this.y = (this.y - right).toInt()
    this.z = (this.z - right).toInt()
    return this
   ...
   * Component-wise minus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun minus(right: Double): ArrayVec3i {
    this.x = (this.x - right).toInt()
    this.y = (this.y - right).toInt()
    this.z = (this.z - right).toInt()
    return this
   ...
   * Component-wise minus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun minus(right: Int): ArrayVec3i {
    this.x = (this.x - right).toInt()
    this.y = (this.y - right).toInt()
    this.z = (this.z - right).toInt()
    return this
   ...
   * Component-wise minus operation between vector and scalar. Result will be written into left vector
   */
  override operator fun minus(right: Long): ArrayVec3i {
    this.x = (this.x - right).toInt()
    this.y = (this.y - right).toInt()
    this.z = (this.z - right).toInt()
    return this
   ...
   */
  override operator fun times(right: Vec3f): ArrayVec3i {
    this.x = (this.x * right.x).toInt()
    this.y = (this.y * right.y).toInt()
    this.z = (this.z * right.z).toInt()
    return this
   ...
   * Component-wise multiplication operation with vectors. Result will be written into left vector
   */
  override operator fun times(right: Vec3d): ArrayVec3i {
    this.x = (this.x * right.x).toInt()
    this.y = (this.y * right.y).toInt()
    this.z = (this.z * right.z).toInt()
    return this
   ...
   * Component-wise multiplication operation with vectors. Result will be written into left vector
   */
  override operator fun times(right: Vec3i): ArrayVec3i {
    this.x = (this.x * right.x).toInt()
    this.y = (this.y * right.y).toInt()
    this.z = (this.z * right.z).toInt()
    return this
   ...
   * Component-wise multiplication operation with vectors. Result will be written into left vector
   */
  override operator fun times(right: Vec3l): ArrayVec3i {
    this.x = (this.x * right.x).toInt()
    this.y = (this.y * right.y).toInt()
    this.z = (this.z * right.z).toInt()
    return this
   ...
   */
  override operator fun times(right: Float): ArrayVec3i {
    this.x = (this.x * right).toInt()
    this.y = (this.y * right).toInt()
    this.z = (this.z * right).toInt()
    return this
   ...
   * Component-wise multiplication operation between vector and scalar. Result will be written into left vector
   */
  override operator fun times(right: Double): ArrayVec3i {
    this.x = (this.x * right).toInt()
    this.y = (this.y * right).toInt()
    this.z = (this.z * right).toInt()
    return this
   ...
   * Component-wise multiplication operation between vector and scalar. Result will be written into left vector
   */
  override operator fun times(right: Int): ArrayVec3i {
    this.x = (this.x * right).toInt()
    this.y = (this.y * right).toInt()
    this.z = (this.z * right).toInt()
    return this
   ...
   * Component-wise multiplication operation between vector and scalar. Result will be written into left vector
   */
  override operator fun times(right: Long): ArrayVec3i {
    this.x = (this.x * right).toInt()
    this.y = (this.y * right).toInt()
    this.z = (this.z * right).toInt()
    return this
