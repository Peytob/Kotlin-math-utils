...
fun main() {
    ...
    vec2Operations.forEach { saveExtensionsFunctionsFile(it.key.vectorDescriptor.destinationPackage, it.key.typeSpec, it.value, "Operations") }
    vec2FactoryMethods.forEach { saveExtensionsFunctionsFile(it.key.vectorDescriptor.destinationPackage, it.key.typeSpec, it.value, "Factories") }
}
