...
private class MutableLengthFactoryGeneratorTemplate : UnaryVecFunctionGeneratorTemplate() {
...
fun generateMutableVecOperations(vec: VectorSpec, targetOperationVectors: Collection<VectorSpec>): Collection<FunSpec> {
    ...
    val normalizeFactoryGeneratorTemplate = MutableNormalizeFactoryGeneratorTemplate()
    val lengthFactoryGeneratorTemplate = MutableLengthFactoryGeneratorTemplate()
