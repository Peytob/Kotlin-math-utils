...
fun generateTimesVectorOperationScalar(leftVector: TypedVectorBase, primitive: Primitive): FunSpec {
    val body = CodeBlock.builder()

    val scalarFormArguments = leftVector.components.joinToString(", ") { component -> "r$component = scalar" }
    body.addStatement("return this.times(%L)", scalarFormArguments)
